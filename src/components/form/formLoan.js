    ...
    <div className='bg-white rounded-lg p-4 w-full relative my_font_DMSANS text-gray-dark'>
      ...
      <form onChange={onChangeDataForm}>
        <div className='flex flex-col gap-3'>
          ...
          <button onClick={goToPosts} className="w-full h-[70px] my_bg_yellow rounded-md text-black font-bold drop-shadow-md transition-all hover:bg-[#ffee89] text-xl text-black" >
